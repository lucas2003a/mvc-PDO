        ...
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <button class="btn btn-success btn-sm" id="abrir-modal" data-bs-toggle="modal" data-bs-target="#modal-registro-cursos">
              <i class="bi bi-plus-circle-fill"></i>Agregar curso</button>
          </div>
        </div>  
      </div>
      <div class="card-body">
      ...
      <div class="modal-content">
        ...
        <form id="formulario-cursos" autocomplete="off">
          ...
          <div class="mb-3">
            ...
            <select id="complejidad" class="form-select form-slect-sm">
              <option value="">Seleccione</option>
  ...
  <script>
    $(document).ready(function (){
      ...
      function registrarCurso(){
        ...
        if(confirm("¿Estás seguro de salvar los datos?")){
          
          //Crear un objeto contenido los datos a guardar
          let datos = {
              operacion     : 'registrar',
      ...
      function abrirModal(){
        datosNuevos = true; //Varible tipo BANDERA
      ...
      //Detectar click en EDITAR (asíncrono)
